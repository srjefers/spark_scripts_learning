...
#df.show()
df.unpivot(['Year','State/Territory','Sex','Age'],['Uncapped Participation Rate: Full-time and Part-time Students','Uncapped Participation Rate: Full-time Students'], 'type', 'val').show()
